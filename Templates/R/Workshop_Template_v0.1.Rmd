...
write_agefile(lake_o_dl[[1]], path = "winBacon_2.2", chronology = 1, 
              corename = "LAKEPINES", cal.prog = 'Bacon') 

# Did it work?
list.files("winBacon_2.2/Cores")
...
tester <- Bacon("LAKEPINES", acc.mean = 10, thick = 50, depths.file = TRUE, suggest = FALSE, ask = FALSE)
...
lake_o_dl[[1]] <- read_bacon("LAKEPINES", add = TRUE, path = "winBacon_2.2/",
                             download = lake_o_dl[[1]], sections = 17)
```

```{r, eval = FALSE}

head(read_bacon("LAKEPINES", add = FALSE, sections = 17))
...
lake_o_dl[[1]] <- read_bacon("LAKEPINES", add = TRUE, 
                             download = lake_o_dl[[1]], sections = 17)
