...
tester <- system.time(Bacon("LAKEPINES", acc.mean = 10, suggest = FALSE, ask = FALSE))
...
After running (it takes this The output is then available in the `Cores/LAKEPINES` folder.
