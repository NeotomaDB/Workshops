...
Within the download object, `sample.meta` stores the core depth and age information for that dataset. We just want to look at the first few lines, so we use the head function.
...
#counts stores the counts, presence/absence data, or percentage data for each taxon for each sample
...
# There's only one chronology, let's take a look at it:
