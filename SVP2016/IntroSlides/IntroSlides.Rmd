...
- Following along today
    - Intro/Background slides can be viewed through this link: http://htmlpreview.github.com/?https://github.com/NeotomaDB/Workshops/blob/master/SVP2016/IntroSlides/IntroSlides.html
    - The primary workshop document can be viewed through this link
https://htmlpreview.github.io/?https://github.com/NeotomaDB/Workshops/blob/master/SVP2016/R/Workshop_SVP2016_v0.1.html#explorer

- All slides and materials are on GitHub
    - The Neotoma Paleoecology Database: https://github.com/NeotomaDB
    - The Workshops section: https://github.com/NeotomaDB/Workshops/tree/master/SVP2016
...
### Installations
  ...
  3. Install the following R packages: **RJSONIO**, **RCurl**, **neotoma**
    + Open up R Studio, then type: install.packages(‘RJSONIO’, ‘RCurl’, ‘neotoma’)
...
- Focus of this workshop!
    ...
    - API
    - R
    - Database snapshots (housed on [www.neotomadb.org/snapshots](www.neotomadb.org/snapshots))
...
- Primary vertebrate contacts:
    ...
    - Russ Graham, mailto:[rgraham@ems.psu.edu](mailto:rgraham@ems.psu.edu)
