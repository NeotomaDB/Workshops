...
neotoma2::summary(bc_records) %>% DT::datatable(data = ., 
                options = list(scrollX = "100%", dom = 't'))
```
...
There were originally `r sum(stringr::str_detect(neotomatx$variablename, "Achnanthes.*"))` different taxa identified as being within the genus *Pinus* (including *Pinus*., *Pinus monticola*, and *Pinus monticola/P. albicaulis*). The above code reduces them all to a single taxonomic group *Pinus-undiff*.
